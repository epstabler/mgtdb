...
file: mgtdbp-dev.py
   ...
   (For line mode editing, I start the loop with: rlwrap python mgtdbp-dev.py)
...
# to run parser from command line, put the call to go1 here:

# this p is small enough for: a b b b b a b b b b
#go1(mgxx,'T',-0.000000001)

# this p is small enough for:
